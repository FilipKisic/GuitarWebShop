    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-8 col-md-12 col-sm-12">
                <h1 class="guitar-title">Slash "Victoria" Les Paul Standard Goldtop</h1>
                <p class="guitar-description">The Slash "Victoria" Les Paul™ Standard Goldtop features a maple top, a solid mahogany body with a
                    dark finish on the back, and Slash’s personal touches, including a C-shape neck profile, Gibson
                    Custom BurstBucker™ Alnico 2 pickups, color-coordinated hardware appointments, hand-wired
                    electronics with Orange Drop® capacitors and a vintage-style hardshell case. Exclusive to the Slash
                    Collection is Slash’s “Skully” signature drawing on the back of the headstock, Slash’s signature on
                    the truss rod cover, a blank truss rod cover in the case, Slash-approved Ernie Ball® strings, and
                    four Slash Jim Dunlop Tortex® picks.</p>
                <h1 class="guitar-price">$ 2,999.00</h1>
                <button type="submit" class="btn btn-warning custom-button">Add to cart</button>
            </div>
            <div class="col-lg-4 col-md-12 col-sm-12">
                <img src="res/images/Slash.png" class="img-fluid custom-image" alt="">
            </div>
        </div>
    </div>
    <footer>
